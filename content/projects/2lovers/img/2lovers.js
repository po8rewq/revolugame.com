...
var Main = function() {
	age.core.Engine.call(this,800,320,new states.IntroState(),true,60,"#D0F4F7","game");
};
Main.__name__ = true;
Main.main = function() {
	age.Loader.addResource("/assets/img/portfolio/2lovers/" + "img/animPlayer1.png",age.ResourceType.IMAGE,"player1");
	age.Loader.addResource("/assets/img/portfolio/2lovers/" + "img/animPlayer2.png",age.ResourceType.IMAGE,"player2");
	age.Loader.addResource("/assets/img/portfolio/2lovers/" + "img/animPlayer2inv.png",age.ResourceType.IMAGE,"player2inv");
	age.Loader.addResource("/assets/img/portfolio/2lovers/" + "maps/map1.json",age.ResourceType.TEXT,"map1");
	age.Loader.addResource("/assets/img/portfolio/2lovers/" + "maps/map2.json",age.ResourceType.TEXT,"map2");
	age.Loader.addResource("/assets/img/portfolio/2lovers/" + "maps/map3.json",age.ResourceType.TEXT,"map3");
	age.Loader.addResource("/assets/img/portfolio/2lovers/" + "maps/map4.json",age.ResourceType.TEXT,"map4");
	age.Loader.addResource("/assets/img/portfolio/2lovers/" + "maps/map5.json",age.ResourceType.TEXT,"map5");
	age.Loader.addResource("/assets/img/portfolio/2lovers/" + "maps/map6.json",age.ResourceType.TEXT,"map6");
	age.Loader.addResource("/assets/img/portfolio/2lovers/" + "maps/map7.json",age.ResourceType.TEXT,"map7");
	age.Loader.addResource("/assets/img/portfolio/2lovers/" + "maps/map8.json",age.ResourceType.TEXT,"map8");
	age.Loader.addResource("/assets/img/portfolio/2lovers/" + "maps/endmap.json",age.ResourceType.TEXT,"endmap");
	age.Loader.addResource("/assets/img/portfolio/2lovers/" + "img/item.png",age.ResourceType.IMAGE,"item");
	age.Loader.addResource("/assets/img/portfolio/2lovers/" + "img/itemInverted.png",age.ResourceType.IMAGE,"itemInverted");
	age.Loader.addResource("/assets/img/portfolio/2lovers/" + "img/pic.png",age.ResourceType.IMAGE,"pic");
	age.Loader.addResource("/assets/img/portfolio/2lovers/" + "img/picInverted.png",age.ResourceType.IMAGE,"picInverted");
	age.Loader.addResource("/assets/img/portfolio/2lovers/" + "img/door.png",age.ResourceType.IMAGE,"door");
	age.Loader.addResource("/assets/img/portfolio/2lovers/" + "img/potion1.png",age.ResourceType.IMAGE,"potion1");
	age.Loader.addResource("/assets/img/portfolio/2lovers/" + "img/potion1inverted.png",age.ResourceType.IMAGE,"potion1inverted");
	age.Loader.addResource("/assets/img/portfolio/2lovers/" + "img/gate.png",age.ResourceType.IMAGE,"gate");
	age.Loader.addResource("/assets/img/portfolio/2lovers/" + "img/gateinverted.png",age.ResourceType.IMAGE,"gateinverted");
	age.Loader.addResource("/assets/img/portfolio/2lovers/" + "img/switch.png",age.ResourceType.IMAGE,"switch");
	age.Loader.addResource("/assets/img/portfolio/2lovers/" + "img/switchinverted.png",age.ResourceType.IMAGE,"switchinverted");
	age.Loader.addResource("/assets/img/portfolio/2lovers/" + "img/tile_topblue.png",age.ResourceType.IMAGE,"topblue");
	age.Loader.addResource("/assets/img/portfolio/2lovers/" + "img/tile_blue.png",age.ResourceType.IMAGE,"blue");
	age.Loader.addResource("/assets/img/portfolio/2lovers/" + "img/tile_invertedblue.png",age.ResourceType.IMAGE,"invertedblue");
	age.Loader.addResource("/assets/img/portfolio/2lovers/" + "img/tile_topgreen.png",age.ResourceType.IMAGE,"topgreen");
	age.Loader.addResource("/assets/img/portfolio/2lovers/" + "img/tile_green.png",age.ResourceType.IMAGE,"green");
	age.Loader.addResource("/assets/img/portfolio/2lovers/" + "img/tile_invertedgreen.png",age.ResourceType.IMAGE,"invertedgreen");
...
age.core.Input.onMouseMove = function(pEvt) {
	...
	age.core.Input.mouseOverGame = age.core.Input.mousePosition.x >= 0 && age.core.Input.mousePosition.x <= bounds.width && age.core.Input.mousePosition.y >= 0 && age.core.Input.mousePosition.y <= bounds.height;
};
